/*1.Desarrollo el script de creación de la base de datos con las tablas, 
que permita implementar y satisfacer todos los requerimientos mencionados en el caso. (10 pts)*/
